...
export const SHOP_ITEMS = {
  ...
  'führerschein_bus': {
    ...
    description: 'Berechtigung zum Führen von Bussen',
    price: 25000,
    duration: 0,
    autoRenewable: false,
    emoji: '🚌',
  ...
  'luxus_pass': {
    id: 'luxus_pass',
    name: 'Luxus-Pass',
    description: '🎩 /collect 45min + 8.000€ Gehaltsklasse (24h) | 💸 KEINE Überweisungsgebühren | 🛒 50% Shop-Rabatt | 🎁 Alle Versicherungen KOSTENLOS | 🔄 -15% Auto-Verlängerung | 💰 80.000€ + 250 Credits monatlich | +5% Zinsen',
    price: 500000,
    duration: 60,
    autoRenewable: true,
    emoji: '🎩',
  ...
  'credits_free_pass': {
    ...
    description: '🎁 7 Tage kostenloser Einstieg | 💎 20 Credits Bonus beim Kauf | 💰 5% Rabatt beim Ausgeben von Credits | ⚠️ Nur einmal pro Account verfügbar',
    price: 0,
    duration: 7,
    autoRenewable: false,
    emoji: '🎁',
    ...
    metadata: {
      ...
      creditsSpendingDiscount: 0.05, // 5% Rabatt beim Ausgeben
      creditsPurchaseBonus: 0, // Kein Bonus beim Kauf
      monthlyCredits: 0,
      oneTimeOnly: true // Markiert als einmalig
    }
  },
  ...
  'credits_basic_pass': {
    ...
    description: '💎 100 Credits monatlich | 💰 50 Credits Bonus beim Kauf | 🛒 15% Rabatt beim Ausgeben von Credits | 🔄 Monatlich verlängerbar',
    price: 75000,
    duration: 30,
    autoRenewable: true,
    emoji: '💎',
    ...
    metadata: {
      ...
      creditsSpendingDiscount: 0.15, // 15% Rabatt beim Ausgeben
      creditsPurchaseBonus: 0, // Kein Bonus beim Kauf
      monthlyCredits: 100
    }
  },
  ...
  'credits_standard_pass': {
    ...
    description: '💎 175 Credits monatlich | 💰 150 Credits Bonus beim Kauf | 🛒 25% Rabatt beim Ausgeben von Credits | 🎁 +15% Bonus beim Credits-Kauf | 🔄 Monatlich verlängerbar',
    price: 190000,
    duration: 30,
    autoRenewable: true,
    emoji: '⭐',
    ...
    metadata: {
      ...
      creditsSpendingDiscount: 0.25, // 25% Rabatt beim Ausgeben
      creditsPurchaseBonus: 0.15, // +15% beim Credits-Kauf
      monthlyCredits: 175
    }
  },
  ...
  'credits_elite_plus_pass': {
    ...
    description: '💎 215 Credits monatlich | 💰 250 Credits Bonus beim Kauf | 🛒 35% Rabatt beim Ausgeben von Credits | 🎁 +25% Bonus beim Credits-Kauf | 🔄 Monatlich verlängerbar',
    price: 345000,
    duration: 30,
    autoRenewable: true,
    emoji: '👑',
    category: 'credits_passes',
    metadata: {
      bonusCreditsOnPurchase: 250,
      creditsSpendingDiscount: 0.35, // 35% Rabatt beim Ausgeben
      creditsPurchaseBonus: 0.25, // +25% beim Credits-Kauf
      monthlyCredits: 215
    }
  },
