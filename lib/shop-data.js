...
export const SHOP_ITEMS = {
  ...
  'luxus_pass': {
    id: 'luxus_pass',
    name: 'Luxus-Pass',
    description: '🎩 +5% Sparkonto-Zinsen | 💳 Keine Kontoführungsgebühren | 💸 KEINE Überweisungsgebühren | 🛡️ -25% auf Schutzbriefe | 🎁 80.000€ + 250 Credits monatlich | 🛒 50% Shop-Rabatt (außer Credits & VIP)',
    price: 500000,
    duration: 60,
    autoRenewable: true,
    emoji: '🎩',
