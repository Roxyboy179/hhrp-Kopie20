...
// ═══════════════════════════════════════════════════════════════
// 💎 REWARD-BALANCING: Alle Boxes auf ~+40% positiven EV kalibriert
// Struktur je Box:  35% Verlust · 30% Break-even · 20% Win · 10% Big Win · 4% Mega · 1% Credit-Jackpot
// Spieler verlieren bei ~35% der Öffnungen, gewinnen bei ~65% (im Schnitt +40% Return)
// ═══════════════════════════════════════════════════════════════
export const CREDIT_CRATES = {
  bronze: {
    ...
    color: '#CD7F32',
    maxPayout: 700000,
    description: 'Kleiner Einstieg – bis 700.000€ Gewinn möglich',
    rewards: [
      { chance: 0.35, type: 'money',   min: 30000,  max: 70000,  label: 'Pech gehabt'     },
      { chance: 0.30, type: 'money',   min: 70000,  max: 120000, label: 'Kleiner Gewinn'  },
      { chance: 0.20, type: 'money',   min: 120000, max: 200000, label: 'Mittlerer Gewinn'},
      { chance: 0.10, type: 'money',   min: 200000, max: 350000, label: 'Großer Gewinn'   },
      { chance: 0.04, type: 'money',   min: 350000, max: 700000, label: 'Mega Gewinn'     },
      { chance: 0.01, type: 'credits', min: 50,     max: 100,    label: 'Credit-Jackpot'  }
    ]
  },
  silber: {
    id: 'silber',
    ...
    color: '#C0C0C0',
    maxPayout: 2700000,
    description: 'Solide Chancen – bis 2.700.000€ Gewinn möglich',
    rewards: [
      { chance: 0.35, type: 'money',   min: 120000,  max: 280000,  label: 'Pech gehabt'     },
      { chance: 0.30, type: 'money',   min: 280000,  max: 520000,  label: 'Kleiner Gewinn'  },
      { chance: 0.20, type: 'money',   min: 520000,  max: 880000,  label: 'Mittlerer Gewinn'},
      { chance: 0.10, type: 'money',   min: 880000,  max: 1500000, label: 'Großer Gewinn'   },
      { chance: 0.04, type: 'money',   min: 1500000, max: 2700000, label: 'Mega Gewinn'     },
      { chance: 0.01, type: 'credits', min: 200,     max: 400,     label: 'Credit-Jackpot'  }
    ]
  },
  gold: {
    id: 'gold',
    ...
    color: '#FFD700',
    maxPayout: 9000000,
    description: 'Große Gewinne – bis 9.000.000€ möglich',
    rewards: [
      { chance: 0.35, type: 'money',   min: 400000,  max: 900000,  label: 'Pech gehabt'     },
      { chance: 0.30, type: 'money',   min: 900000,  max: 1800000, label: 'Kleiner Gewinn'  },
      { chance: 0.20, type: 'money',   min: 1800000, max: 3200000, label: 'Mittlerer Gewinn'},
      { chance: 0.10, type: 'money',   min: 3200000, max: 5200000, label: 'Großer Gewinn'   },
      { chance: 0.04, type: 'money',   min: 5200000, max: 9000000, label: 'Mega Gewinn'     },
      { chance: 0.01, type: 'credits', min: 1000,    max: 2000,    label: 'Credit-Jackpot'  }
    ]
  },
  diamond: {
    id: 'diamond',
    ...
    color: '#00FFFF',
    maxPayout: 31000000,
    description: 'Jackpot-Chance – bis 31.000.000€ möglich',
    rewards: [
      { chance: 0.35, type: 'money',   min: 1500000,  max: 3500000,  label: 'Pech gehabt'     },
      { chance: 0.30, type: 'money',   min: 3500000,  max: 7000000,  label: 'Kleiner Gewinn'  },
      { chance: 0.20, type: 'money',   min: 7000000,  max: 11000000, label: 'Mittlerer Gewinn'},
      { chance: 0.10, type: 'money',   min: 11000000, max: 19000000, label: 'Großer Gewinn'   },
      { chance: 0.04, type: 'money',   min: 19000000, max: 31000000, label: 'Mega Gewinn'     },
      { chance: 0.01, type: 'credits', min: 5000,     max: 10000,    label: 'Credit-Jackpot'  }
    ]
  }
};
