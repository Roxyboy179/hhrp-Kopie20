        ...
        >
          ...
          <div className="mt-7 flex flex-col sm:flex-row gap-2">
            ...
            <button
              ...
              disabled={refreshing}
              className="flex-1 h-11 rounded-xl flex items-center justify-center gap-2 text-[12.5px] font-semibold transition-all active:scale-[0.98] border disabled:opacity-60"
              style={{
            ...
            >
              ...
              <span>{refreshing ? 'Prüfe...' : 'Status prüfen'}</span>
            </button>
            ...
            <a
              ...
              className="flex-1 h-11 rounded-xl flex items-center justify-center gap-2 text-[12.5px] font-semibold transition-all active:scale-[0.98] border"
              style={{
