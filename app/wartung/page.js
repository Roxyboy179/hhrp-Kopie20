        ...
        >
          ...
          <div className="mt-7 flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <button
              ...
              disabled={refreshing}
              className="flex-1 min-w-[280px] h-14 sm:h-[58px] px-8 sm:px-12 rounded-xl flex items-center justify-center gap-3 text-[14px] sm:text-[15px] font-semibold transition-all active:scale-[0.98] border disabled:opacity-60"
              style={{
            ...
            >
              ...
              <span className="whitespace-nowrap">{refreshing ? 'Prüfe...' : 'Status prüfen'}</span>
            </button>
            ...
            <a
              ...
              className="flex-1 min-w-[280px] h-14 sm:h-[58px] px-8 sm:px-12 rounded-xl flex items-center justify-center gap-3 text-[14px] sm:text-[15px] font-semibold transition-all active:scale-[0.98] border"
              style={{
