  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: '#050505' }}>
      <div className="max-w-md w-full text-center">
        ...
        >
          <Wrench className="w-12 h-12" style={{ color: '#eab308' }} />
        </div>
        ...
        <p className="text-lg mb-8" style={{ color: 'rgba(255,255,255,0.5)' }}>
          Wir führen gerade Wartungsarbeiten durch, um HHRP noch besser zu machen. 
        </p>
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <p className="font-semibold text-white">Geplante Dauer</p>
          </div>
          <p className="text-sm" style={{ color: 'rgba(255,255,255,0.6)' }}>
            Die Wartung dauert voraussichtlich 30-60 Minuten
          </p>
        </div>

        {/* Message */}
        <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>
          Bitte versuche es in Kürze erneut. Danke für deine Geduld!
        </p>
