...
// ⚠️ Free Credits um 65% reduziert (auf 35% des Originals)
// ⚠️ Free XP um 45% reduziert (auf 55% des Originals)
const BATTLE_PASS_REWARDS = [
  { tier: 1, free: { type: 'credits', amount: 18, label: '18 Credits' }, premium: { type: 'money', amount: 5000, label: '5.000€' } },
  { tier: 2, free: { type: 'xp', amount: 275, label: '275 XP' }, premium: { type: 'credits', amount: 200, label: '200 Credits' } },
  { tier: 3, free: { type: 'credits', amount: 26, label: '26 Credits' }, premium: { type: 'item', item_id: 'führerschein_pkw', label: 'Führerschein (PKW)', alternativeCredits: 300 } },
  { tier: 4, free: { type: 'money', amount: 3000, label: '3.000€' }, premium: { type: 'credits', amount: 250, label: '250 Credits' } },
  { tier: 5, free: { type: 'xp', amount: 413, label: '413 XP' }, premium: { type: 'money', amount: 10000, label: '10.000€' } },
  { tier: 6, free: { type: 'credits', amount: 35, label: '35 Credits' }, premium: { type: 'item', item_id: 'führerschein_motorrad', label: 'Motorradschein', alternativeCredits: 400 } },
  { tier: 7, free: { type: 'money', amount: 4000, label: '4.000€' }, premium: { type: 'credits', amount: 300, label: '300 Credits' } },
  { tier: 8, free: { type: 'xp', amount: 550, label: '550 XP' }, premium: { type: 'item', item_id: 'waffenschein', label: 'Waffenschein', alternativeCredits: 350 } },
  { tier: 9, free: { type: 'credits', amount: 44, label: '44 Credits' }, premium: { type: 'money', amount: 15000, label: '15.000€' } },
  ...
  { tier: 11, free: { type: 'xp', amount: 688, label: '688 XP' }, premium: { type: 'credits', amount: 350, label: '350 Credits' } },
  { tier: 12, free: { type: 'credits', amount: 53, label: '53 Credits' }, premium: { type: 'money', amount: 20000, label: '20.000€' } },
  ...
  { tier: 14, free: { type: 'xp', amount: 825, label: '825 XP' }, premium: { type: 'credits', amount: 400, label: '400 Credits' } },
  { tier: 15, free: { type: 'credits', amount: 61, label: '61 Credits' }, premium: { type: 'item', item_id: 'jagdschein', label: 'Jagdschein', alternativeCredits: 500 } },
  { tier: 16, free: { type: 'money', amount: 7000, label: '7.000€' }, premium: { type: 'money', amount: 25000, label: '25.000€' } },
  { tier: 17, free: { type: 'xp', amount: 963, label: '963 XP' }, premium: { type: 'credits', amount: 450, label: '450 Credits' } },
  { tier: 18, free: { type: 'credits', amount: 70, label: '70 Credits' }, premium: { type: 'item', item_id: 'versicherung_rechtsschutz', label: 'Rechtsschutzversicherung', alternativeCredits: 400 } },
  { tier: 19, free: { type: 'money', amount: 8000, label: '8.000€' }, premium: { type: 'money', amount: 30000, label: '30.000€' } },
  { tier: 20, free: { type: 'xp', amount: 1100, label: '1.100 XP' }, premium: { type: 'item', item_id: 'vip_premium', label: 'VIP Mitgliedschaft', alternativeCredits: 800 } },
  { tier: 21, free: { type: 'credits', amount: 79, label: '79 Credits' }, premium: { type: 'credits', amount: 500, label: '500 Credits' } },
  { tier: 22, free: { type: 'money', amount: 9000, label: '9.000€' }, premium: { type: 'money', amount: 35000, label: '35.000€' } },
  { tier: 23, free: { type: 'xp', amount: 1238, label: '1.238 XP' }, premium: { type: 'item', item_id: 'führerschein_bus', label: 'Bus Führerschein', alternativeCredits: 550 } },
  { tier: 24, free: { type: 'credits', amount: 88, label: '88 Credits' }, premium: { type: 'money', amount: 40000, label: '40.000€' } },
  { tier: 25, free: { type: 'money', amount: 10000, label: '10.000€' }, premium: { type: 'credits', amount: 600, label: '600 Credits' } },
  { tier: 26, free: { type: 'xp', amount: 1375, label: '1.375 XP' }, premium: { type: 'item', item_id: 'versicherung_kranken', label: 'Krankenversicherung', alternativeCredits: 700 } },
  { tier: 27, free: { type: 'credits', amount: 96, label: '96 Credits' }, premium: { type: 'money', amount: 45000, label: '45.000€' } },
  { tier: 28, free: { type: 'money', amount: 12000, label: '12.000€' }, premium: { type: 'credits', amount: 700, label: '700 Credits' } },
  { tier: 29, free: { type: 'xp', amount: 1650, label: '1.650 XP' }, premium: { type: 'money', amount: 50000, label: '50.000€' } },
  { tier: 30, free: { type: 'credits', amount: 105, label: '105 Credits' }, premium: { type: 'item', item_id: 'credits_basic_pass', label: 'Credits Basic Pass', alternativeCredits: 1000 } },
];
...
async function handleBattlePassPurchase(request) {
  ...
  try {
    ...
    // ✅ Mindestens 5 Tage bis Monatsende erforderlich
    const daysRemaining = getDaysRemainingInMonth();
    if (daysRemaining < BATTLE_PASS_CONFIG.MIN_DAYS_TO_PURCHASE) {
      return NextResponse.json({
        error: `Battle Pass kann nicht mehr gekauft werden. Es sind nur noch ${daysRemaining} Tag(e) bis Monatsende übrig (mindestens ${BATTLE_PASS_CONFIG.MIN_DAYS_TO_PURCHASE} Tage benötigt).`,
      }, { status: 400 });
    }
    ...
    if (userCredits < finalCost) {
      return NextResponse.json({
        error: `Nicht genug Credits. Benötigt: ${finalCost}, vorhanden: ${userCredits}`,
      }, { status: 400 });
    }
    ...
    return NextResponse.json({
      ...
      message: `Battle Pass Kauf wird verarbeitet… (${finalCost} Credits werden vom HHRP Server abgezogen, in wenigen Sekunden aktiv)`,
    });
  } catch (error) {
...
// POST /api/battle-pass/cancel
// ✅ NEU: Kündigt den Premium Battle Pass (setzt purchased=false)
async function handleBattlePassCancel(request) {
  const user = getBpAuthContext(request);
  if (!user) return NextResponse.json({ error: 'Nicht authentifiziert' }, { status: 401 });
  ...
  try {
    ...
    if (existingPending) {
      return NextResponse.json({
        success: true,
        pending: true,
        message: 'Kündigung wird verarbeitet…',
      });
    }
    ...
    if (insertErr) {
      ...
      return NextResponse.json({ error: 'Konnte Kündigung nicht starten', details: insertErr.message }, { status: 500 });
    }
...
async function handleSystemStatusCheck(request) {
  ...
  // Service-Definitionen — User-freundliche Namen wie bei professionellen Status-Pages
  const services = [
    {
      id: 'service_main',
      name: 'Bewerbungsportal',
      description: 'Hauptseite & öffentliche Bereiche',
      url: `${baseUrl}/`,
      method: 'GET',
    ...
    {
      id: 'discord_auth',
      name: 'Anmeldung & Authentifizierung',
      description: 'Login per Discord',
    ...
    },
    {
      id: 'service_profil',
      name: 'Mein Profil',
      description: 'Profil-Übersicht & persönliche Daten',
      url: `${baseUrl}/profil`,
      method: 'GET',
    ...
    },
    {
      ...
      description: 'Team-, Praktikum- & Uprank-Bewerbungen',
    ...
    },
    {
      id: 'service_team',
      name: 'Team-Übersicht',
      description: 'Öffentliche Mitglieder-Liste',
      url: `${baseUrl}/team`,
      method: 'GET',
      expectedStatus: [200, 304],
      internal: true,
    },
    {
      id: 'service_voice',
      name: 'Voice Support',
      description: 'Live-Sprachunterstützung',
    ...
    },
    {
      id: 'discord_cdn',
      name: 'Bilder & Medien',
      description: 'Avatar- und Asset-Bereitstellung',
  ...
  const BOT_DEPENDENT_IDS = [
    ...
    'service_team',     // Team-Übersicht
    'service_voice',    // Voice Support
    'discord_cdn',      // Bilder & Medien
  ];
  const botResult = results.find((r) => r.id === 'discord_bot');
  const botOffline = botResult && botResult.status === 'down';
  if (botOffline) {
