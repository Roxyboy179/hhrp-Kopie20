            ...
            {user ? (
              <>
                ...
                <Button 
                  ...
                  className="rounded-xl h-13 px-8 text-base border-neutral-700 text-neutral-400 hover:text-white hover:border-neutral-500 hover:bg-neutral-900 transition-all"
                >
