      ...
      <div className="max-w-2xl w-full relative animate-[fade-in-up_0.6s_cubic-bezier(0.22,1,0.36,1)]">
        ...
        >
          ...
          <div className="mt-6 sm:mt-7 flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            >
              <svg className="flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} style={{ width: '20px', height: '20px' }}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
              <span style={{ whiteSpace: 'nowrap' }}>Erneut versuchen</span>
            </button>
